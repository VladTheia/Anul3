...
void* M1Init(void *var) {
	
	pthread_barrier_wait(&barrier);
}

void* M2Init(void *var) {
	
}

void* M3Init(void *var) {
	
}

void* M4Init(void *var) {
	
}

void* M5Init(void *var) {
	
}

void* M6Init(void *var) {
	
}

void* M7Init(void *var) {
	
}

void* C1Init(void *var) {
...
int main(int argc, char *argv[])
{
	...
	pthread_create(&(tid[0]), NULL, M1Init, NULL);
	pthread_create(&(tid[1]), NULL, M2Init, NULL);
	pthread_create(&(tid[2]), NULL, M3Init, NULL);
	pthread_create(&(tid[3]), NULL, M4Init, NULL);
	pthread_create(&(tid[4]), NULL, M5Init, NULL);
	pthread_create(&(tid[5]), NULL, M6Init, NULL);
	pthread_create(&(tid[6]), NULL, M7Init, NULL);

	pthread_create(&(tid[0]), NULL, C1Init, NULL);
	pthread_create(&(tid[1]), NULL, C2Init, NULL);
	pthread_create(&(tid[2]), NULL, C3Init, NULL);
	pthread_create(&(tid[3]), NULL, C4Init, NULL);
